...
ActiveRecord::Schema.define(version: 20_210_528_112_249) do
  ...
  create_table 'lightning_transactions', force: :cascade do |t|
    ...
    t.index %w[tx_id input], name: 'index_lightning_transactions_on_tx_id_and_input', unique: true
  ...
  create_table 'stale_candidates', force: :cascade do |t|
    ...
    t.index %w[coin height], name: 'index_stale_candidates_on_coin_and_height', unique: true
  end
