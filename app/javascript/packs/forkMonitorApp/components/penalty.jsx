  ...
  render() {
    return(
      <tr className="pullLeft" >
        ...
        <td>
          <Explorer mempool coin={ this.props.penalty.block.coin } tx={ this.props.penalty.opening_tx_id }/>&nbsp;
        ...
        <td>
          <Explorer mempool coin={ this.props.penalty.block.coin } tx={ this.props.penalty.tx_id }/>&nbsp;
        </td>
        <td>
